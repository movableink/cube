cube.piece.type.area = function(board, socket) {
  var timeout,
      data = [],
      dt0;
  ...
  if (mode == "edit") {
    ...
    time.selectAll("option")
        .data([
          {description: "30 Minute / 10-Second", value: 18e5 + "/" + 1e4},
  ...
  function deserialize(json) {
    ...
    var socketId = Math.random() * 10000000000000000;
    ...
    if (mode == "edit") {
      ...
      function store(message) {
        ...
        if(d.socket_id != socketId) { return; }
